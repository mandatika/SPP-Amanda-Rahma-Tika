        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('spp.update', $spps->id) }}">
                            @csrf
                            @method('PUT')
                            <div class="row mb-3">
                                <label for="tahun" class="col-md-4 col-form-label text-md-end">{{ __('Tahun') }}</label>
                                <div class="col-md-6">
                                    <input id="tahun" type="text" value="{{$spps->tahun}}" class="form-control @error('tahun') is-invalid @enderror" 
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="nominal" type="text" value="{{$spps->nominal}}" class="form-control @error('nominal') is-invalid @enderror" 
